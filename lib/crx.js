...
var filename_template = filename_template_base + ".crx";
var filename_template_zip = filename_template_base + ".zip";
...
exports.init = function(grunt){
  ...
  function expandConfiguration(taskConfig, defaults){
    ...
    // Expanding zip file destination
    if (typeof config.zipDest !== 'undefined' && !path.extname(config.zipDest)){
      var zipFilename = config.zipFilename || filename_template_zip;
      config.zipDest = path.join(config.zipDest, zipFilename);
      processKeys.push('zipDest');
    }
